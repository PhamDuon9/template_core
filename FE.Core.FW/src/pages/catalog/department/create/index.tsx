...
import { getDepartment, getDepartmentTree, postDepartment } from '@/apis/services/DepartmentService';
...
const Create: React.FC<Props> = ({ open, setOpen, reload, branches, departments }) => {
    ...
    return (
        <>
            <Modal title={<Text>Thêm phòng ban</Text>}
                        ...
                        <Col span={24}>
                            ...
                            >
                                <Select
                                    ...
                                    // }
                                    placeholder='-Chọn-' options={branches} />
                            </Form.Item>
                        </Col>
                        <Col span={24}>
                            <Form.Item
