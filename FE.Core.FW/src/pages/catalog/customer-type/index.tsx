   ...
   */
    ...
    const searchFormSubmit = async (current: number = 1, pageSize: number = 20): Promise<void> => {
        try {
            ...
            setList((response.data || []) as CustomerTypeModel[]);
            setPagination({
                ...pagination,
                current,
    ...
    const columns: ProColumns<CustomerTypeModel>[] = [
        {
            title: 'STT',
            dataIndex: 'index',
            width: 80,
        ...
        <div className='layout-main-content'>
                                    ...
                                    <Panel header='Tìm kiếm' key='1'>
                                        ...
                                        >
                                            <Row gutter={16} justify='start'>
                                                <Col span={6}>
                                                    <Form.Item
                                                        label={'Tên loại hình KH'}
                                                        labelCol={{ span: 24 }}
                                                        wrapperCol={{ span: 17 }}
                                                        name='TextSearch'
                                                    >
                                                        <Input
                                                            placeholder='Tên loại hình KH'
                                                            allowClear />
                                                    </Form.Item>
                                                </Col>
            ...
            >
                ...
                <ProTable<CustomerTypeModel>
                    ...
                    headerTitle="Tiêu đề"
                    toolBarRender={() => [
                        <Permission noNode navigation={layoutCode.catalogCustomerType as string} bitPermission={PermissionAction.Add}>
